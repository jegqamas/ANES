...
void Mapper024_GetPrec(double inVal, double inMax, double outMax, double * val)
{
...
void Mapper024_OnAPUGetAudioSample(double *board_sample)
{
   // (*board_sample)= (audio_pulse_table[sc_vrc6_p1_output + sc_vrc6_p2_output] + audio_tnd_table[sc_vrc6_st_output]) * vrc6_playback_amplitude;
    ...
    Mapper024_GetPrec(sc_vrc6_p1_output, 0xF, 0.14, &vrc6_playback_outs[0]);// Normalize Square 1 output from 0-15 into 0 - 14 % of the mix
    Mapper024_GetPrec(sc_vrc6_p2_output, 0xF, 0.14, &vrc6_playback_outs[1]);// Normalize Square 2 output from 0-15 into 0 - 14 % of the mix
    Mapper024_GetPrec(sc_vrc6_st_output, 0xFF, 0.44, &vrc6_playback_outs[2]);// Normalize DMC-PCM output from 0-255 into 0 - 44 % of the mix
